...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'settings.audio':        'Efectos de sonido',
    'settings.audio.desc':   'Sonidos de acierto, fallo y racha',
    'settings.music':        'Música ambiente',
    'settings.music.desc':   'Música de fondo en el menú principal',
  ...
  en: {
    ...
    'settings.audio.desc':   'Correct, wrong and streak sounds',
    'settings.music':        'Ambient music',
    'settings.music.desc':   'Background music on the main menu',
